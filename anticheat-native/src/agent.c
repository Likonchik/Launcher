...
/* Имя класса нелегально, если содержит символ вне набора внутренних имён JVM
 * (буквы/цифры/_/$ и разделители . /). Инжекторы дают классам нелегальные имена,
 * чтобы обходить детект по сигнатурам — само наличие такого имени = признак инъекции. */
